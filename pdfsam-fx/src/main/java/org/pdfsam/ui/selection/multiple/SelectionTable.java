...
public class SelectionTable extends TableView<SelectionTableRowData> implements ModuleOwned, RestorableView {
    ...
    private SelectionTableData data = new SelectionTableData();
	...
	public SelectionTable(String ownerModule, boolean canDuplicateItems, boolean canMove,
        ...
        data.initTopSectionContextMenu(this, contextMenu, Arrays.stream(columns).anyMatch(PageRangesColumn.class::isInstance));
        data.initItemsSectionContextMenu(this, contextMenu, canDuplicateItems, canMove);
        data.initBottomSectionContextMenu(this, contextMenu);
        setContextMenu(contextMenu);
        eventStudio().addAnnotatedListeners(this);
        eventStudio().add(SelectionChangedEvent.class, e -> data.selectionChangedConsumer.accept(e), ownerModule);
    }

    MenuItem createMenuItem(String text, MaterialDesignIcon icon) {
